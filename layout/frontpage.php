...
$templatecontext = [
    ...
    'image_fgs' => $OUTPUT->image_url('ou_img/Federal_Government_of_Somalia', 'theme_ktt_boost_child_som'),
    'image_wb' => $OUTPUT->image_url('ou_img/The_world_bank', 'theme_ktt_boost_child_som'),
